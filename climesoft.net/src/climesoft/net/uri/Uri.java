 ...
 */
package climesoft.net.uri;

import climesoft.net.util.MiscUtils;
import climesoft.net.util.StringBuilderPool;

import java.net.URI;
import java.net.URISyntaxException;

import static climesoft.net.util.Assertions.assertNotEmpty;
import static climesoft.net.util.MiscUtils.isEmpty;
