...
import climesoft.net.util.UriEncoder;
...
import static climesoft.net.util.HttpUtils.extractCharset;
import static climesoft.net.util.HttpUtils.validateSupportedScheme;
