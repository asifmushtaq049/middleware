...
public final class AsyncHttpClientConfigDefaults {
  ...
  public static final String ASYNC_CLIENT_CONFIG_ROOT = "climesoft.net.";
  ...
  static {
//    try (InputStream is = AsyncHttpClientConfigDefaults.class.getResourceAsStream("D:\\Final Year\\MiddleWare\\resources\\ahc-version.properties")) {
    try (InputStream is = AsyncHttpClientConfigDefaults.class.getResourceAsStream("/ahc-version.properties")) {
      Properties prop = new Properties();
      prop.load(is); // null pointer Exception here
