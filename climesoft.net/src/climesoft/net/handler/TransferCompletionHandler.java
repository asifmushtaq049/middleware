...
import climesoft.net.AsyncCompletionHandlerBase;
import climesoft.net.HttpResponseBodyPart;
...
/**
 * A {@link climesoft.net.AsyncHandler} that can be used to notify a set of {@link TransferListener}
 * <br>
 * <blockquote>
 * <pre>
...
public class TransferCompletionHandler extends AsyncCompletionHandlerBase {
  ...
  /**
   * Create a TransferCompletionHandler that will not accumulate bytes. The resulting {@link climesoft.net.Response#getResponseBody()},
   * {@link climesoft.net.Response#getResponseBodyAsStream()} will throw an IllegalStateException if called.
   */
  ...
  /**
   * Create a TransferCompletionHandler that can or cannot accumulate bytes and make it available when {@link climesoft.net.Response#getResponseBody()} get called. The
   * default is false.
   *
