...
import climesoft.net.handler.ProgressAsyncHandler;
 ...
 * {@link climesoft.net.AsyncHandler.State#CONTINUE}
 *
...
public abstract class AsyncCompletionHandler<T> implements ProgressAsyncHandler<T> {
   ...
   *
   * @return a {@link climesoft.net.AsyncHandler.State} telling to CONTINUE
