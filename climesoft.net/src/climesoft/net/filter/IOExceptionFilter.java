...
public interface IOExceptionFilter {
  ...
  /**
   * An {@link climesoft.net.AsyncHttpClient} will invoke {@link IOExceptionFilter#filter} and will
   * use the returned {@link FilterContext} to replay the {@link climesoft.net.Request} or abort the processing.
   *
