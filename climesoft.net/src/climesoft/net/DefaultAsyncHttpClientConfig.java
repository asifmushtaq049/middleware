...
import climesoft.net.channel.ChannelPool;
import climesoft.net.channel.DefaultKeepAliveStrategy;
import climesoft.net.channel.KeepAliveStrategy;
import climesoft.net.config.AsyncHttpClientConfigDefaults;
import climesoft.net.cookie.CookieStore;
import climesoft.net.cookie.ThreadSafeCookieStore;
import climesoft.net.filter.IOExceptionFilter;
import climesoft.net.filter.RequestFilter;
import climesoft.net.filter.ResponseFilter;
import climesoft.net.proxy.ProxyServer;
import climesoft.net.proxy.ProxyServerSelector;
import climesoft.net.util.ProxyUtils;

import java.util.*;
import java.util.concurrent.ThreadFactory;
import java.util.function.Consumer;

import static climesoft.net.config.AsyncHttpClientConfigDefaults.*;
 ...
 * -Dclimesoft.net.nameOfTheProperty
 *
