...
import climesoft.net.util.AuthenticatorUtils;
import climesoft.net.util.StringBuilderPool;
...
import static climesoft.net.util.MessageDigestUtils.pooledMd5MessageDigest;
import static climesoft.net.util.MiscUtils.isNonEmpty;
import static climesoft.net.util.StringUtils.appendBase16;
import static climesoft.net.util.StringUtils.toHexString;
