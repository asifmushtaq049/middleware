 ...
 */
package climesoft.net.netty.channel;
...
import climesoft.net.channel.NoopChannelPool;
import climesoft.net.netty.NettyResponseFuture;
import climesoft.net.netty.OnLastHttpContentCallback;
import climesoft.net.netty.handler.AsyncHttpClientHandler;
import climesoft.net.netty.handler.HttpHandler;
import climesoft.net.netty.handler.WebSocketHandler;
import climesoft.net.netty.request.NettyRequestSender;
import climesoft.net.netty.ssl.DefaultSslEngineFactory;
...
public class ChannelManager {
  ...
  private ChannelFactory<? extends Channel> getEpollSocketChannelFactory() {
    try {
      return (ChannelFactory<? extends Channel>) Class.forName("climesoft.net.netty.channel.EpollSocketChannelFactory").newInstance();
    } catch (Exception e) {
      throw new IllegalArgumentException(e);
    }
  }
