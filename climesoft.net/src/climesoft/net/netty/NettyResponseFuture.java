...
import climesoft.net.ListenableFuture;
...
import climesoft.net.netty.channel.ConnectionSemaphore;
import climesoft.net.netty.request.NettyRequest;
...
import static climesoft.net.util.DateUtils.unpreciseMillisTime;
...
public final class NettyResponseFuture<V> implements ListenableFuture<V> {
  ...
  // climesoft.net.ListenableFuture
