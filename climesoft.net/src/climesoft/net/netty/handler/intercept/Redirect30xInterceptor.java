...
import climesoft.net.handler.MaxRedirectException;
...
import static climesoft.net.util.HttpConstants.ResponseStatusCodes.*;
import static climesoft.net.util.HttpUtils.followRedirect;
import static climesoft.net.util.HttpUtils.isSameBase;
import static climesoft.net.util.MiscUtils.isNonEmpty;
import static climesoft.net.util.ThrowableUtil.unknownStackTrace;
