...
import climesoft.net.netty.channel.ChannelState;
import climesoft.net.netty.request.NettyRequestSender;
import climesoft.net.ntlm.NtlmEngine;
import climesoft.net.proxy.ProxyServer;
import climesoft.net.spnego.SpnegoEngine;
import climesoft.net.spnego.SpnegoEngineException;
...
import static climesoft.net.Dsl.realm;
import static climesoft.net.util.AuthenticatorUtils.NEGOTIATE;
import static climesoft.net.util.AuthenticatorUtils.getHeaderWithPrefix;
