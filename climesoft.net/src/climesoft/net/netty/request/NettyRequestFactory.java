...
import climesoft.net.Realm;
import climesoft.net.Request;
import climesoft.net.netty.request.body.*;
import climesoft.net.proxy.ProxyServer;
import climesoft.net.request.body.generator.FileBodyGenerator;
import climesoft.net.request.body.generator.InputStreamBodyGenerator;
import climesoft.net.request.body.generator.ReactiveStreamsBodyGenerator;
import climesoft.net.uri.Uri;
import climesoft.net.util.StringUtils;

import java.nio.charset.Charset;

import static io.netty.handler.codec.http.HttpHeaderNames.*;
import static climesoft.net.util.AuthenticatorUtils.perRequestAuthorizationHeader;
import static climesoft.net.util.AuthenticatorUtils.perRequestProxyAuthorizationHeader;
import static climesoft.net.util.HttpUtils.*;
import static climesoft.net.util.MiscUtils.isNonEmpty;
import static climesoft.net.ws.WebSocketUtils.getWebSocketKey;
