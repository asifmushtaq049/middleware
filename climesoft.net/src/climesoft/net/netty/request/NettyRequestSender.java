 ...
 */
package climesoft.net.netty.request;
...
import climesoft.net.Realm.AuthScheme;
import climesoft.net.exception.PoolAlreadyClosedException;
import climesoft.net.exception.RemotelyClosedException;
...
import climesoft.net.handler.TransferCompletionHandler;
import climesoft.net.netty.NettyResponseFuture;
import climesoft.net.netty.OnLastHttpContentCallback;
import climesoft.net.netty.SimpleFutureListener;
import climesoft.net.netty.channel.*;
import climesoft.net.netty.timeout.TimeoutsHolder;
import climesoft.net.proxy.ProxyServer;
import climesoft.net.resolver.RequestHostnameResolver;
...
import static climesoft.net.util.AuthenticatorUtils.perConnectionAuthorizationHeader;
import static climesoft.net.util.AuthenticatorUtils.perConnectionProxyAuthorizationHeader;
import static climesoft.net.util.HttpConstants.Methods.CONNECT;
import static climesoft.net.util.HttpConstants.Methods.GET;
import static climesoft.net.util.MiscUtils.getCause;
import static climesoft.net.util.ProxyUtils.getProxyServer;
